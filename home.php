            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white shadow-lg p-6 rounded-lg flex flex-col items-center space-y-4">
                    ...
                    <div class="flex flex-wrap justify-center space-x-2">
                        ...
                        <img src="<?= htmlspecialchars($app['app_icon']) ?>" alt="<?= htmlspecialchars($app['app_name']) ?>" title="<?= htmlspecialchars($app['app_name']) ?>" class="w-6 h-6">
                        <?php endforeach; ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex flex-wrap justify-center space-x-2 mt-4">
                        ...
                        <a href="<?= htmlspecialchars($link['link_url']) ?>" target="_blank" class="px-3 py-2 bg-blue-500 text-white text-sm rounded hover:bg-blue-600 flex items-center space-x-2">
                            <?php if (!empty($link['icon'])): ?>
                            <img src="<?= htmlspecialchars($link['link_icon']) ?>" alt="" class="w-4 h-4">
                            <?php endif; ?>
